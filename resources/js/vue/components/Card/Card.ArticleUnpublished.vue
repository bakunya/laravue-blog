        ...
        <div class="card-body">
            ...
            <div class="collapse mt-1" :id="id">
                <div class="card card-body p-0 border-0">
                    <button-action :title="'Publish'" :variant="'btn-info'" @action="publish" :loading="loading" />
...
<script>
    ...
    import { articlePublish } from '../../fetch/article.publish'
    ...
    export default {
        ...
        setup(props) {
            ...
            return {
                ...
                id: computed(() => `unpublished-id-${id}`),
                id_target: computed(() => `#unpublished-id-${id}`)
            }
